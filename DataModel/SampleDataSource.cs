...
namespace ODataPad.DataModel
{
    ...
    public abstract class SampleDataCommon : ODataPad.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        private SampleDataSource()
        {
            ...
            var group1 = new SampleDataGroup("ServiceGroup",
                    "OData Services",
            ...
            var group2 = new SampleDataGroup("MetadataGroup",
                    "Service Metadata",
                    "Group Subtitle: 2",
                    "Assets/LightGray.png",
                    "Group Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor scelerisque lorem in vehicula. Aliquam tincidunt, lacus ut sagittis tristique, turpis massa volutpat augue, eu rutrum ligula ante a ante");
            group2.Items.Add(new SampleDataItem("MetadataGroup-Item-1",
                    "Item Title: 1",
                    "Item Subtitle: 1",
                    "Assets/DarkGray.png",
